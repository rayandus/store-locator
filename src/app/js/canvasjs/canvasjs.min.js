...
borderThickness:0,borderColor:"black",cornerRadius:0,backgroundColor:null,margin:2,wrap:!0,maxWidth:null,dockInsidePlotArea:!1,publicProperties:{options:"readWrite",bounds:"readOnly",chart:"readOnly"}},Toolbar:{itemBackgroundColor:"white",itemBackgroundColorOnHover:"#2196f3",buttonBorderColor:"#2196f3",buttonBorderThickness:1,fontColor:"black",fontColorOnHover:"white",publicProperties:{options:"readWrite",chart:"readOnly"}},Legend:{name:null,verticalAlign:"center",horizontalAlign:"right",fontSize:14,
...
Y.pro={sCH:pa[Y.fSDec("Bi`su")][Y.fSDec("bsdehuIsdg")]};Y._fTWm=function(h){if("undefined"===typeof Y.pro.sCH&&!eb)try{var l,v=h[Y.fSDec("buy")];v[Y.fSDec("udyuC`rdmhod")]=Y.fSDec("unq");v[Y.fSDec("gnou")]=11+Y.fSDec("qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg");l=h.height-11;v[Y.fSDec("bmd`sSdbu")](0,l,v[Y.fSDec("ld`rtsdUdyu")](Y.fSDec("Ono,Bnlldsbh`m!Wdsrhno")).width,11);v[Y.fSDec("ghmmRuxmd")]=h.backgroundColor;v[Y.fSDec("ghmmSdbu")](0,l,v[Y.fSDec("ld`rtsdUdyu")](Y.fSDec("Ono,Bnlldsbh`m!Wdsrhno")).width,
11);v[Y.fSDec("ghmmRuxmd")]=Y.fSDec("fsdx");v[Y.fSDec("ghmmUdyu")](Y.fSDec("Ono,Bnlldsbh`m!Wdsrhno"),0,l)}catch(r){}}})();var ib=function(){var h=!1;try{var l=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){h=!0;return!1}});window.addEventListener&&(window.addEventListener("test",null,l),window.removeEventListener("test",null,l))}catch(v){h=!1}return h}(),$a={},xa=null,nb=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=
this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},za=function(h){h.width=1;h.height=1;h.getContext("2d")&&h.getContext("2d").clearRect(0,0,1,1)},ob=function(h,l,v){l=Math.min(this.width,this.height);return Math.max("theme4"===this.theme?0:300<=l?12:11,Math.round(l*(h/400)))},Da=function(){var h=/D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,l="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),v="Sun Mon Tue Wed Thu Fri Sat".split(" "),
